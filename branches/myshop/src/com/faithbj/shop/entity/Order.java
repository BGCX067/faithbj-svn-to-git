...
import com.faithbj.custom.vegetable.entity.FieldBlockOrderItem;
...
public class Order extends BaseEntity {
	...
	private Set<FieldBlockOrderItem> fieldBlockOrderItemSet;// 租赁块订单项
	...
	@Cascade(value = { CascadeType.DELETE })
	@OrderBy("createDate desc")
	public Set<FieldBlockOrderItem> getFieldBlockOrderItemSet()
	{
		return fieldBlockOrderItemSet;
	}

	public void setFieldBlockOrderItemSet(
			Set<FieldBlockOrderItem> fieldBlockOrderItemSet)
	{
		this.fieldBlockOrderItemSet = fieldBlockOrderItemSet;
	}
