...
import com.faithbj.custom.util.PropertyUtils;
...
//		}
	...
	private Map<String, String> shopConfig = new HashMap<String, String>();
	
	// 后台主页面
	public String main() {
		
		String headerLocation = new PropertyUtils(null, null).getPropery("header.location");
		this.shopConfig.put("headerLocation", headerLocation);
	...
	public void setShopConfig(Map<String, String> shopConfig)
	{
