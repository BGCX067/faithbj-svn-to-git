...
import com.faithbj.shop.bean.TenpayConfig;
import com.faithbj.shop.bean.SystemConfig.StoreFreezeTime;
import com.faithbj.shop.bean.TenpayConfig.TenpayType;
...
import com.faithbj.shop.entity.PaymentConfig.PaymentConfigType;
...
public class PaymentAction extends BaseShopAction {
	...
	public String gateway() throws Exception {
		...
		if (paymentType == PaymentType.recharge) {
			...
			if (order.getPaymentStatus() == com.faithbj.shop.entity.Order.PaymentStatus.paid) {
	...
	public String tenpayReturn() throws Exception {
		...
		if (StringUtils.equals(pay_result, "0")) {
			...
			paymentResult = PaymentResult.success;
			//消费20元积1分
			//loginMember.setPoint(payment.getTotalAmount().divide(new BigDecimal(20)).intValue());
			//memberService.update(loginMember);
		} else {
			paymentResult = PaymentResult.failure;
		}
