...
public class HtmlServiceImpl implements HtmlService {
	...
	@Resource
	private FieldBlockDao fieldBlockDao;
...
//		HtmlConfig htmlConfig = TemplateConfigUtil.getHtmlConfig(HtmlConfig.FIELDBLOCK_CONTENT);
//		Map<String, Object> data = getCommonData();
//		data.put("fieldBlock", fieldBlock);
//		String htmlFilePath = fieldBlock.getHtmlFilePath();
//		String templateFilePath = htmlConfig.getTemplateFilePath();
//		buildHtml(templateFilePath, htmlFilePath, data);
//	}
