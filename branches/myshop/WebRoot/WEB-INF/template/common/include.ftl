...
<link href="${base}/template/common/css/ui.all.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${base}/template/common/js/ui.core.js"></script>
<script type="text/javascript" src="${base}/template/common/js/ui.datepicker.js"></script>
