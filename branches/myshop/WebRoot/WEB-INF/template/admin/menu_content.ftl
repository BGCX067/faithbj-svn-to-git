...
<body class="menu">
	<div class="menuContent">
		<dl>
			...
			<dd>
				<a href="article!list.action" target="mainFrame">新闻管理</a>
			</dd>
			<dd>
				<a href="article_category!list.action" target="mainFrame">新闻分类</a>
			</dd>
			<dd>
				<a href="online!list.action" target="mainFrame">在线问答管理</a>
			</dd>
		...
		<dl>
			...
			<dd>
				<a href="build_html!articleInput.action" target="mainFrame">新闻更新</a>
			</dd>
			<dd>
