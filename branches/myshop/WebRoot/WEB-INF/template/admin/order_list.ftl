...
<body class="list">
	<div class="body">
		<div class="listBar">
			<h1><span class="icon">&nbsp;</span>配送单管理&nbsp;<span class="pageInfo">总记录数: ${pager.totalCount}(共${pager.pageCount}页)</span></h1>
		</div>
		<form id="listForm" action="order!list.action" method="post">
			<div class="operateBar">
				...
				<a href="order!excel.action" target="mainFrame">导出</a>
			</div>
			...
			<table class="listTable">
				<tr>
					...
					<th>
						<span class="sort" name="shipMobile">手机号码</span>
					</th>
					<th>
						<span class="sort" name="shipName">收货人姓名</span>
					</th>
					<th>
						<span class="sort" name="shipArea">配送地区</span>
					</th>
