...
$().ready( function() {
	...
	// 在线体验只读提示
	//$.message("warn", "提示：您现在访问的是MyShop体验站点，您的任何修改性操作将不被执行！");
...
<body class="admin">
	<div class="adminBar">
		<span class="icon">&nbsp;</span>欢迎使用菜精灵网店管理系统！
	</div>
	<div class="body">
		<div class="bodyLeft">
			<table class="listTable">
				...
				<tr>
					...
					<td>
						<a href="http://www.faithbj.com">http://www.faithbj.com</a>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<a href="http://certificate.faithbj.com">在线查询</a>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<span class="green">您拥有至高无上的权利，可以将本软件应用于任何商业用途</span>
					</td>
				</tr>
			</table>
			<div class="blank"></div>
		...
		<p class="copyright">Copyright © 2012 faithbj.com All Rights Reserved.</p>
	</div>
</body>
</html>
