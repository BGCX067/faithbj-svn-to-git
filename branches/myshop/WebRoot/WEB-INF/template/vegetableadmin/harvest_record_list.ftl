...
<title>收获记录列表 - Powered By ${systemConfig.systemName}</title>
...
<body class="list">
	<div class="body">
		...
		<form id="listForm" action="harvest_record!list.action" method="post">
			<div class="operateBar">
				<input type="button" class="addButton" onclick="location.href='harvest_record!add.action'" value="添加收获记录" />
				<label>查找:</label>
			...
			<table class="listTable">
				...
				<#list pager.list as list>
					<tr>
						...
						<td>
							<a href="harvest_record!edit.action?id=${list.id}" title="编辑">[编辑]</a>
						</td>
					</tr>
				</#list>
			</table>
			<#if (pager.list?size > 0)>
				<div class="pagerBar">
					<input type="button" class="deleteButton" url="harvest_record!delete.action" value="删 除" disabled hidefocus="true" />
