...
<body class="list">
	<div class="body">
		...
		<form id="listForm" action="seed!list.action" method="post">
			<div class="operateBar">
				<input type="button" class="addButton" onclick="location.href='seed!add.action'" value="添加种子" />
				<label>查找:</label>
			...
			<table class="listTable">
				<tr>
					...
					<th>
						<span class="sort" name="type">起始时间</span>
					</th>
					<th>
						<span class="sort" name="type">结束时间</span>
					</th>
					<th>
						操作
					</th>
				...
				<#list pager.list as list>
					<tr>
						...
						<td>
							<a href="seed!edit.action?id=${list.id}" title="编辑">[编辑]</a>
						</td>
					</tr>
				</#list>
			</table>
			<#if (pager.list?size > 0)>
				<div class="pagerBar">
					<input type="button" class="deleteButton" url="seed!delete.action" value="删 除" disabled hidefocus="true" />
