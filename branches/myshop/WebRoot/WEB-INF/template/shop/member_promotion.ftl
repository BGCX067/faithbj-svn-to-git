					...
					<ul>
	                    ...
	                    <li class="profile">
	                    	<ul>
	                            ...
	                            <li class="current"><a href="member!promotion.action">升级用户</a></li>
	                        </ul>
	                    </li>
	                    <li class="deposit">
	                    	<ul>
	                        	...
	                        	<li><a href="deposit!getUserCardList.action">我的礼品卡</a></li>
	                        </ul>
	                    </li>
	                </ul>
				</div>
					...
					<form id="inputForm" class="validate" action="profile!update.action" method="post">
						<table class="inputTable">
							<tr>
								...
								<td>
									<a href="toDeliver.ftl">
											 <input type="button" name="refreshCard" value="点击定期配送用户" />
									</a>
								</td>
							</tr>
							<tr>
								...
								<td>
									<a href="toDeliver.ftl">
											 <input type="button" name="refreshCard" value="点击土地承包用户" />
									</a>
								</td>
							</tr>
