...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" action="<#if isAddAction>/faith/brand/save<#else>/faith/brand/update</#if>" enctype="multipart/form-data" method="post">
			...
			<table class="inputTable">
				<tr>
					...
					<td>
						<input type="text" name="name" class="formText" value="${(brand.name)!}" />
				...
				<tr>
					...
					<td>
						<input type="text" name="url" class="formText" value="${(brand.url)!}" />
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td>
						<input type="text" name="orderList" class="formText" value="${(brand.orderList)!}" title="只允许输入零或正整数" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<textarea name="introduction" id="editor" class="editor">${(brand.introduction)!}</textarea>
					</td>
				</tr>
			</table>
