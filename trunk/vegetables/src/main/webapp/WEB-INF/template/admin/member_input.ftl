...
<title>添加/编辑会员 - Powered By faithby</title>
		...
		<form id="validateForm" action="<#if isAddAction>save<#else>update</#if>" method="post">
			...
			<table class="inputTable">
				...
				<tr>
					...
					<td>
						<input type="text" name="email" class="formText" value="${(member.email)!}" />
						<label class="requireField">*</label>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="score" class="formText" value="${(member.score)!"0"}" title="只允许输入零或正整数" />
						<label class="requireField">*</label>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="deposit" class="formText" value="${(member.deposit)!"0"}" title="只允许输入大于或等于零的数" />
						<label class="requireField">*</label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<label>
						<input type="text" name="isAccountEnabled" value="${(member.isAccountEnabled)!true}" />启用
							<#--<@checkbox name="isAccountEnabled" value="${(member.isAccountEnabled)!true}" />启用-->
						</label>
					</td>
				</tr>
				<tr>
