...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" action="<#if isAddAction>${base}/faith/area/save<#else>${base}/faith/area/update</#if>" method="post">
			...
			<table class="inputTable">
				...
				<tr>
					...
					<td>
						<input type="text" name="name" class="formText" value="${(area.name)!}" />
				...
				<tr>
					...
					<td>
						<input type="text" name="orderList" class="formText" value="${(area.orderList)!}" />
					</td>
				</tr>
			</table>
