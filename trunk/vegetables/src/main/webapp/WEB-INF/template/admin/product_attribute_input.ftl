...
<link href="${base}/vegetables/admin/css/input.css" rel="stylesheet" type="text/css" />
...
$().ready(function() {
	...
	function addAttributeOptionTr() {
		var attributeOptionTrHtml = '<tr class="attributeOptionTr"><th>选项内容:</th><td><input type="text" name="attributeOptionList" class="formText attributeOption {required: true}" />&nbsp;<img src="${base}/vegetables/admin/images/input_delete_icon.gif" class="deleteImage" alt="删除" /></td></tr>';
		...
		<form id="inputForm" class="validate" action="<#if isAdd??>product_attribute!save.action<#else>product_attribute!update.action</#if>" method="post">
			...
			<table class="inputTable">
					...
					<#list productAttribute.attributeOptionList as list>
						<tr class="attributeOptionTr">
							...
							<td>
								...
								&nbsp;<img src="${base}/vegetables/admin/images/input_delete_icon.gif" class="deleteImage" alt="删除" />
							</td>
						</tr>
					</#list>
				...
				<#else>
					...
					<td>
						<img src="${base}/vegetables/admin/images/input_add_icon.gif" id="addImage" alt="增加选项" />&nbsp;&nbsp;&nbsp;&nbsp;
						<img src="${base}/vegetables/admin/images/input_remove_icon.gif" id="removeImage" alt="减少选项" />
					</td>
				</tr>
				<tr>
					<th>
