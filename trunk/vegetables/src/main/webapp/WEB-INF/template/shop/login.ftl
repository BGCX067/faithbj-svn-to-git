...
<title>会员登录 - Powered By faithbj</title>
...
<body class="login">
	...
	<div class="body">
		<div class="loginDetail">
			...
			<div class="middle">
				<form id="loginForm" action="/cjlhome/login" method="post">
					<input type="hidden" id="loginRedirectUrl" name="loginRedirectUrl" />
					<table>
						<tr>
							<th>用户名</th>
							<td>
								<input type="text" id="memberUsername" name="j_username" class="formText" />
							</td>
						</tr>
						<tr>
							<th>密&nbsp;&nbsp;&nbsp;码</th>
							<td>
								<input type="password" id="memberPassword" name="j_password" class="formText" />
							</td>
						</tr>
						<tr>
							<th>验证码</th>
