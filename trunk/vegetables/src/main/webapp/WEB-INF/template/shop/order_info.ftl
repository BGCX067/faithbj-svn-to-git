...
<title>填写订单信息 - Powered By faithbj</title>
...
<body class="orderInfo">
	...
	<div class="body">
		...
		<div class="orderInfoDetail">
			<form id="orderInfoForm" action="${base}/cjlhome/order/save" method="post">
						...
						<td>
							<ul>
								<#list loginMember.receiverSet as receiver>
									<li>
										<label>
											<input type="radio" name="receiver.id" class="receiverId" value="${receiver.id} <#if receiver.isDefault> checked</#if>"> </input>
								...
								<li>
									<label>
										<input type="radio" id="otherReceiver" name="useNewReceiver"  class="receiverId" value="<#if (!loginMember.receiverSet?? || loginMember.receiverSet?size == 0)> checked</#if>" > </input>
									...
									<table id="otherReceiverTable" class="otherReceiverTable">
										...
										<tr>
											...
											<td>
												<input type="text" name="address" class="formText" />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="receiverPhone" name="phone" class="formText" />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" name="mobile" class="formText" />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" name="zipCode" class="formText" />
												<label class="requireField">*</label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<label>
													<input type="radio" name="isSaveReceiver" value="true" />保存收货地址
												</label>
											</td>
										</tr>
									</table>
							...
							<table id="deliveryTypeTable" class="deliveryTypeTable">
								<#list allDeliveryTypeList as deliveryType>
									<tr>
										<th>
											<label>
												<input type="radio" name="deliveryType.id" value="${deliveryType.id}" deliveryFee="${deliveryType.getDeliveryFee(totalProductWeight)}" deliveryMethod="${deliveryType.deliveryMethod}" /> 
												${deliveryType.name}
											</label>
										</th>
										<td>
				...
				<div class="blank"></div>
				<a class="backCartItem" href="${base}/product/caritem/list"><span class="icon">&nbsp;</span>返回购物车</a>
