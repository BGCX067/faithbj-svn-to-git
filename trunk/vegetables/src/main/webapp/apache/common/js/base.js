...
function priceCurrencyFormat(price) {
	...
	return faithbj.currencySign + price;
}
...
function orderCurrencyFormat(price) {
	price = setScale(price, faithbj.orderScale, faithbj.orderRoundType);
	return faithbj.currencySign + price;
}
...
$().ready( function() {
	...
	$("textarea.wysiwyg").tinymce({
		script_url: faithbj.base + "/template/common/tiny_mce/tiny_mce.js",
		language: "zh",
		theme: "advanced",
