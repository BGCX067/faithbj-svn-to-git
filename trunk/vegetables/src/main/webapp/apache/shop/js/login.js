...
$().ready( function() {
	...
	function loginWindowCaptchaImageRefresh() {
		$("#loginWindowCaptchaImage").attr("src", faithbj.base + "/captcha.jpg?timestamp" + (new Date()).valueOf());
	}
	...
	function loginCaptchaImageRefresh() {
		$("#loginCaptchaImage").attr("src", faithbj.base + "/captcha.jpg?timestamp" + (new Date()).valueOf());
	}
