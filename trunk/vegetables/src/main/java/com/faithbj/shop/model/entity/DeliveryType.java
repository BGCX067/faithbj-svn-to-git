...
public class DeliveryType extends BaseEntity {
	...
	/**
	 * 配送周期，单位是周：4周（1个月）、12周（1个季度）、25周（半年）或52周（一年）
	 */
	private Integer period;
	/**
	 * /配送频率，如1次/周、2次/周或3次/周
	 */
	private Integer frequency;
	/**
	 * 每次的配送量，如1人配量，2人配量，3人配量，4人配量等；
	 */
	private Integer deliveryAmount;
	/**
	 * 每周的配送日，如周一、周三、周六、周日
	 */
	private Integer deliveryDate;// 排序
	...
	public BigDecimal getDeliveryFee(double totalWeight) {
	  ...
	  public void onSave()
	  {
	    if ((this.firstWeight == null) || (this.firstWeight.intValue() < 0))
	      this.firstWeight = Double.valueOf(0);
	    if ((this.continueWeight == null) || (this.continueWeight.intValue() < 1))
	      this.continueWeight = Double.valueOf(1);
	    if ((this.firstWeightPrice == null) || (this.firstWeightPrice.compareTo(new BigDecimal(0)) < 0))
	      this.firstWeightPrice = new BigDecimal(0);
	    if ((this.continueWeightPrice == null) || (this.continueWeightPrice.compareTo(new BigDecimal(0)) < 0))
	      this.continueWeightPrice = new BigDecimal(0);
