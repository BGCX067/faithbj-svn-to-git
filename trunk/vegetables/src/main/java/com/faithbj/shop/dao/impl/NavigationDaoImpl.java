...
import com.faithbj.shop.model.entity.Navigation.Position;
...
public class NavigationDaoImpl extends BaseDaoImpl<Navigation, String> implements NavigationDao {
	...
	public List<Navigation> getTopNavigationList() {
		String hql = "from Navigation as navigation where navigationPosition = ? and isVisible = ? order by navigation.orderList asc";
