...
import com.faithbj.shop.model.configuration.TenpayConfig;
import com.faithbj.shop.model.configuration.TenpayConfig.TenpayType;
...
//	@Cacheable(modelId = "caching")
	...
	public String buildTenpayDirectPaymentUrl(PaymentConfig paymentConfig, String paymentSn, BigDecimal totalAmount, String description, String ip) {
		...
		String return_url = SystemConfigUtil.getShopUrl() + TenpayConfig.RETURN_URL;// 结果处理URL
	...
	public String buildTenpayPartnerPaymentUrl(PaymentConfig paymentConfig, String paymentSn, BigDecimal totalAmount, String description) {
		...
		String mch_returl = SystemConfigUtil.getShopUrl() + TenpayConfig.RETURN_URL;// 结果处理URL
		String show_url = SystemConfigUtil.getShopUrl() + TenpayConfig.RETURN_URL;// 结果展示URL
		String attach = data;// 商户数据
		String key = tenpayConfig.getKey();// 密钥
